...
const Slider = () => {
  ...
  return (
    <div className="relative py-4 sm:py-6 lg:py-8">
      ...
      <div
        className="absolute right-0 flex space-x-4 mt-2 mr-6
                     sm:mt-4 
                     md:mt-6
      ...
      >
        <button
          onClick={() => scroll("left")}
          className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center bg-[#1c1c1e] text-white ${
